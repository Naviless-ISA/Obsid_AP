...
Podem ser caracterizados tanto como uma região mais ampla onde são vistas mudanças graduais entre duas áreas, como uma região limite onde diferenças agudas separam comunidades bem distintas, i.e: terra e água. 

Uma das características dos ecótonos é a sua biodiversidade, sendo que são áreas que apresentam uma variedade de nichos elevada, indicando que processos de especiação (o processo de criar diversas especies com um ancestral comum para se adaptarem ao local) são elevados nestas regiões. Esta especiação acaba por gerar um alto numero de espécies endêmicas (especies que ocorrem só naquele local). Ecótonos não tem a sua endemicidade como característica marcante, mas são formados por uma combinação de espécies provenientes das comunidades adjacentes. 


![[Pasted image 20260301192532.png]] 